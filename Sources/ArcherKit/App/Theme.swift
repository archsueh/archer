...
/// Design tokens for archer's chrome — refined minimal, low-contrast palette,
...
enum Theme {
    ...
    static var resolved: Resolved {
        let theme = ArcherSettingsModel.shared.selectedTerminalTheme
...
func bundleResourceURL(name: String, ext: String, subdirectory: String) -> URL? {
    let bundleName = "Archer_ArcherKit"
    let candidates: [URL] = [
