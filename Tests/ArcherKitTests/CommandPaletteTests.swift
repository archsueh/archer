...
final class FuzzyMatcherTests: XCTestCase {
    ...
    func testWordBoundaryBonus() throws {
        ...
        // mid-word match.
        let boundary = FuzzyMatcher.score(query: "p", against: "archer-project")
...
final class PaletteIndexMatchTests: XCTestCase {
    private let items: [PaletteItem] = [
        ...
        PaletteItem(id: "2", title: "archer-project", subtitle: "workspace",
                    kind: .workspace(workspaceId: UUID(), windowId: UUID()),
                    symbol: "folder", iconAsset: nil),
    ...
    func testFuzzyMatchSurfacesBestTitle() {
        ...
        // "archer-project" (mid-string post-boundary).
