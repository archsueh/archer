...
final class CodexUsagePillFormatterTests: XCTestCase {
    ...
    func testContextUsedPercentMatchesCodexFormula() {
        ...
        XCTAssertEqual(CodexUsagePill.contextUsedPercent(used: 27204, window: 353_400), 5)
        // Empty conversation (only the baseline in context) reads as 0% used.
        XCTAssertEqual(CodexUsagePill.contextUsedPercent(used: 12000, window: 353_400), 0)
        XCTAssertEqual(CodexUsagePill.contextUsedPercent(used: 5000, window: 353_400), 0)
        // Full window → 100%.
        XCTAssertEqual(CodexUsagePill.contextUsedPercent(used: 353_400, window: 353_400), 100)
    ...
    func testTokensText() {
        ...
        XCTAssertEqual(CodexUsagePill.tokensText(989_754), "989k")
